...
const languageStrings = {
    'en': {
        translation: {
            GET_JOURNEY_DEFAULT: 'Thank you for using OCTO Metropolitan, this feature will be available soon',
            RECIPES: recipes.RECIPE_EN_US,
            SKILL_NAME: 'Metropolitan',
            WELCOME_MESSAGE: "Welcome to %s. You can ask a question like, how can I go to Opera from Bastille? ... Now, what can I help you with?",
...
const handlers = {
    ...
    'GetJourneyIntent': function () {
        this.attributes.speechOutput = this.t('GET_JOURNEY_DEFAULT');
